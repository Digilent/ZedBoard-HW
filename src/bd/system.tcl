...
if { ${design_name} eq "" } {
  ...
  set_property USER_COMMENTS.comment_0 "Sometimes, changes within the VDMA properties wizard will
unfortunately overwrite some config variables which are not
editable via the wizard, such as _NUM_MASTERS,
which needs to be then manually set to 4 in the block
properties.

Warnings of width mismatches relating to _frame_ptr_in
and that only lower order bits will be connected are not
harmless and will actually break the synchronization." [get_bd_designs $design_name]
...
digilentinc.com:ip:rgb2vga:*\
xilinx.com:ip:proc_sys_reset:*\
digilentinc.com:video:video_scaler:*\
...
proc create_root_design { parentCell } {
  ...
  set AXI_BayerToRGB_A [ create_bd_cell -type ip -vlnv digilentinc.com:user:AXI_BayerToRGB AXI_BayerToRGB_A ]

  # Create instance: AXI_BayerToRGB_B, and set properties
  set AXI_BayerToRGB_B [ create_bd_cell -type ip -vlnv digilentinc.com:user:AXI_BayerToRGB AXI_BayerToRGB_B ]

  # Create instance: AXI_BayerToRGB_C, and set properties
  set AXI_BayerToRGB_C [ create_bd_cell -type ip -vlnv digilentinc.com:user:AXI_BayerToRGB AXI_BayerToRGB_C ]

  # Create instance: AXI_BayerToRGB_D, and set properties
  set AXI_BayerToRGB_D [ create_bd_cell -type ip -vlnv digilentinc.com:user:AXI_BayerToRGB AXI_BayerToRGB_D ]

  # Create instance: AXI_GammaCorrection_A, and set properties
  set AXI_GammaCorrection_A [ create_bd_cell -type ip -vlnv digilentinc.com:user:AXI_GammaCorrection AXI_GammaCorrection_A ]

  # Create instance: AXI_GammaCorrection_B, and set properties
  set AXI_GammaCorrection_B [ create_bd_cell -type ip -vlnv digilentinc.com:user:AXI_GammaCorrection AXI_GammaCorrection_B ]

  # Create instance: AXI_GammaCorrection_C, and set properties
  set AXI_GammaCorrection_C [ create_bd_cell -type ip -vlnv digilentinc.com:user:AXI_GammaCorrection AXI_GammaCorrection_C ]

  # Create instance: AXI_GammaCorrection_D, and set properties
  set AXI_GammaCorrection_D [ create_bd_cell -type ip -vlnv digilentinc.com:user:AXI_GammaCorrection AXI_GammaCorrection_D ]
  ...
  set MIPI_CSI_2_RX_A [ create_bd_cell -type ip -vlnv digilentinc.com:ip:MIPI_CSI_2_RX MIPI_CSI_2_RX_A ]
  set_property -dict [list \
    CONFIG.kDebug {false} \
  ...
  set MIPI_CSI_2_RX_B [ create_bd_cell -type ip -vlnv digilentinc.com:ip:MIPI_CSI_2_RX MIPI_CSI_2_RX_B ]
  set_property -dict [list \
    CONFIG.kDebug {false} \
    CONFIG.kGenerateAXIL {true} \
  ] $MIPI_CSI_2_RX_B
  ...
  set MIPI_CSI_2_RX_C [ create_bd_cell -type ip -vlnv digilentinc.com:ip:MIPI_CSI_2_RX MIPI_CSI_2_RX_C ]
  set_property -dict [list \
    CONFIG.kDebug {false} \
    CONFIG.kGenerateAXIL {true} \
  ] $MIPI_CSI_2_RX_C
  ...
  set MIPI_CSI_2_RX_D [ create_bd_cell -type ip -vlnv digilentinc.com:ip:MIPI_CSI_2_RX MIPI_CSI_2_RX_D ]
  set_property -dict [list \
    CONFIG.kDebug {false} \
    CONFIG.kGenerateAXIL {true} \
  ] $MIPI_CSI_2_RX_D
  ...
  set MIPI_D_PHY_RX_A [ create_bd_cell -type ip -vlnv digilentinc.com:ip:MIPI_D_PHY_RX MIPI_D_PHY_RX_A ]
  set_property -dict [list \
    CONFIG.kDebug {false} \
    CONFIG.kGenerateAXIL {true} \
  ...
  set MIPI_D_PHY_RX_B [ create_bd_cell -type ip -vlnv digilentinc.com:ip:MIPI_D_PHY_RX MIPI_D_PHY_RX_B ]
  set_property -dict [list \
    CONFIG.kDebug {false} \
    CONFIG.kGenerateAXIL {true} \
    CONFIG.kLPFromLane0 {false} \
  ...
  set MIPI_D_PHY_RX_C [ create_bd_cell -type ip -vlnv digilentinc.com:ip:MIPI_D_PHY_RX MIPI_D_PHY_RX_C ]
  set_property -dict [list \
    CONFIG.kDebug {false} \
    CONFIG.kGenerateAXIL {true} \
    CONFIG.kLPFromLane0 {false} \
  ...
  set MIPI_D_PHY_RX_D [ create_bd_cell -type ip -vlnv digilentinc.com:ip:MIPI_D_PHY_RX MIPI_D_PHY_RX_D ]
  set_property -dict [list \
    CONFIG.kDebug {false} \
    CONFIG.kGenerateAXIL {true} \
    CONFIG.kLPFromLane0 {false} \
  ...
  # Create instance: frame_ptr_concat, and set properties
  set frame_ptr_concat [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat frame_ptr_concat ]
  set_property CONFIG.NUM_PORTS {4} $frame_ptr_concat
...
\
  ...
  set rgb2vga_0 [ create_bd_cell -type ip -vlnv digilentinc.com:ip:rgb2vga rgb2vga_0 ]
  set_property -dict [list \
    CONFIG.kBlueDepth {4} \
  ...
  set rst_system_150M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset rst_system_150M ]
  ...
  set video_scaler_a [ create_bd_cell -type ip -vlnv digilentinc.com:video:video_scaler video_scaler_a ]

  # Create instance: video_scaler_b, and set properties
  set video_scaler_b [ create_bd_cell -type ip -vlnv digilentinc.com:video:video_scaler video_scaler_b ]

  # Create instance: video_scaler_c, and set properties
  set video_scaler_c [ create_bd_cell -type ip -vlnv digilentinc.com:video:video_scaler video_scaler_c ]

  # Create instance: video_scaler_d, and set properties
  set video_scaler_d [ create_bd_cell -type ip -vlnv digilentinc.com:video:video_scaler video_scaler_d ]

  # Create instance: axi_cama_bta, and set properties
  set axi_cama_bta [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio axi_cama_bta ]
  set_property CONFIG.C_GPIO_WIDTH {4} $axi_cama_bta


  # Create instance: axi_cama_gpio, and set properties
  set axi_cama_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio axi_cama_gpio ]
  set_property CONFIG.C_GPIO_WIDTH {4} $axi_cama_gpio
  ...
  set axi_vdma_a [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_vdma axi_vdma_a ]
  set_property -dict [list \
    ...
    CONFIG.c_s2mm_genlock_num_masters {4} \
    CONFIG.c_s2mm_linebuffer_depth {1024} \
  ] $axi_vdma_a


  # Create instance: axi_vdma_b, and set properties
  set axi_vdma_b [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_vdma axi_vdma_b ]
  set_property -dict [list \
    CONFIG.c_enable_s2mm_frmstr_reg {1} \
    CONFIG.c_enable_s2mm_sts_reg {1} \
    CONFIG.c_include_internal_genlock {0} \
  ...
  set axi_vdma_c [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_vdma axi_vdma_c ]
  set_property -dict [list \
    CONFIG.c_enable_s2mm_frmstr_reg {1} \
    CONFIG.c_enable_s2mm_sts_reg {1} \
    CONFIG.c_include_internal_genlock {0} \
  ...
  set axi_vdma_d [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_vdma axi_vdma_d ]
  set_property -dict [list \
    CONFIG.c_enable_s2mm_frmstr_reg {1} \
    CONFIG.c_enable_s2mm_sts_reg {1} \
    CONFIG.c_include_internal_genlock {0} \
  ...
  set cama_gpio_dir [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant cama_gpio_dir ]

  # Create instance: cama_gpio_oen, and set properties
  set cama_gpio_oen [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant cama_gpio_oen ]
  set_property CONFIG.CONST_VAL {0} $cama_gpio_oen
  ...
  connect_bd_net -net MIPI_D_PHY_RX_0_RxByteClkHS [get_bd_pins MIPI_D_PHY_RX_A/RxByteClkHS] [get_bd_pins MIPI_CSI_2_RX_A/RxByteClkHS]
  ...
  connect_bd_net -net MIPI_D_PHY_RX_1_RxByteClkHS [get_bd_pins MIPI_D_PHY_RX_B/RxByteClkHS] [get_bd_pins MIPI_CSI_2_RX_B/RxByteClkHS]
  connect_bd_net -net MIPI_D_PHY_RX_2_RxByteClkHS [get_bd_pins MIPI_D_PHY_RX_C/RxByteClkHS] [get_bd_pins MIPI_CSI_2_RX_C/RxByteClkHS]
  connect_bd_net -net MIPI_D_PHY_RX_3_RxByteClkHS [get_bd_pins MIPI_D_PHY_RX_D/RxByteClkHS] [get_bd_pins MIPI_CSI_2_RX_D/RxByteClkHS]
  ...
  connect_bd_net -net axi_vdma_0_mm2s_introut [get_bd_pins axi_vdma_a/mm2s_introut] [get_bd_pins irq_concat/In1]
  connect_bd_net -net axi_vdma_0_s2mm_introut [get_bd_pins axi_vdma_a/s2mm_introut] [get_bd_pins irq_concat/In2]
  connect_bd_net -net axi_vdma_1_s2mm_introut [get_bd_pins axi_vdma_c/s2mm_introut] [get_bd_pins irq_concat/In4]
  connect_bd_net -net axi_vdma_2_s2mm_introut [get_bd_pins axi_vdma_b/s2mm_introut] [get_bd_pins irq_concat/In3]
  connect_bd_net -net axi_vdma_3_s2mm_introut [get_bd_pins axi_vdma_d/s2mm_introut] [get_bd_pins irq_concat/In5]
  connect_bd_net -net axi_vdma_a_m_axis_mm2s_tuser [get_bd_pins axi_vdma_a/m_axis_mm2s_tuser] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tuser]
  connect_bd_net -net axi_vdma_b_s2mm_frame_ptr_out [get_bd_pins axi_vdma_b/s2mm_frame_ptr_out] [get_bd_pins frame_ptr_concat/In1]
  connect_bd_net -net axi_vdma_c_s2mm_frame_ptr_out [get_bd_pins axi_vdma_c/s2mm_frame_ptr_out] [get_bd_pins frame_ptr_concat/In2]
  connect_bd_net -net axi_vdma_d_s2mm_frame_ptr_out [get_bd_pins axi_vdma_d/s2mm_frame_ptr_out] [get_bd_pins frame_ptr_concat/In3]
  connect_bd_net -net cama_gpio_dir_dout [get_bd_pins cama_gpio_dir/dout] [get_bd_ports cam_gpio_dir]
  connect_bd_net -net cama_gpio_oen_dout [get_bd_pins cama_gpio_oen/dout] [get_bd_ports cam_gpio_oen]
  ...
  connect_bd_net -net mm_clk_150 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins AXI_BayerToRGB_A/StreamClk] [get_bd_pins AXI_BayerToRGB_B/StreamClk] [get_bd_pins AXI_BayerToRGB_C/StreamClk] [get_bd_pins AXI_BayerToRGB_D/StreamClk] [get_bd_pins AXI_GammaCorrection_A/StreamClk] [get_bd_pins AXI_GammaCorrection_B/StreamClk] [get_bd_pins AXI_GammaCorrection_C/StreamClk] [get_bd_pins AXI_GammaCorrection_D/StreamClk] [get_bd_pins MIPI_CSI_2_RX_A/video_aclk] [get_bd_pins MIPI_CSI_2_RX_B/video_aclk] [get_bd_pins MIPI_CSI_2_RX_C/video_aclk] [get_bd_pins MIPI_CSI_2_RX_D/video_aclk] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins rst_system_150M/slowest_sync_clk] [get_bd_pins video_scaler_a/ap_clk] [get_bd_pins video_scaler_b/ap_clk] [get_bd_pins video_scaler_c/ap_clk] [get_bd_pins video_scaler_d/ap_clk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_mem_intercon_1/S01_ACLK] [get_bd_pins axi_mem_intercon_1/S02_ACLK] [get_bd_pins axi_mem_intercon_1/S03_ACLK] [get_bd_pins axi_vdma_a/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_a/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_a/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_a/s_axis_s2mm_aclk] [get_bd_pins axi_vdma_b/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_b/s_axis_s2mm_aclk] [get_bd_pins axi_vdma_c/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_c/s_axis_s2mm_aclk] [get_bd_pins axi_vdma_d/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_d/s_axis_s2mm_aclk] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/M16_ACLK] [get_bd_pins ps7_0_axi_periph/M17_ACLK] [get_bd_pins ps7_0_axi_periph/M18_ACLK] [get_bd_pins v_axi4s_vid_out_0/aclk]
  ...
  connect_bd_net -net ref_clk_200 [get_bd_pins clk_wiz_0/clk_out3] [get_bd_pins MIPI_D_PHY_RX_A/RefClk] [get_bd_pins MIPI_D_PHY_RX_B/RefClk] [get_bd_pins MIPI_D_PHY_RX_C/RefClk] [get_bd_pins MIPI_D_PHY_RX_D/RefClk]
  connect_bd_net -net rgb2vga_0_vga_pBlue [get_bd_pins rgb2vga_0/vga_pBlue] [get_bd_ports vga_pBlue]
  connect_bd_net -net rgb2vga_0_vga_pGreen [get_bd_pins rgb2vga_0/vga_pGreen] [get_bd_ports vga_pGreen]
  connect_bd_net -net rgb2vga_0_vga_pHSync [get_bd_pins rgb2vga_0/vga_pHSync] [get_bd_ports vga_pHSync]
  connect_bd_net -net rgb2vga_0_vga_pRed [get_bd_pins rgb2vga_0/vga_pRed] [get_bd_ports vga_pRed]
  connect_bd_net -net rgb2vga_0_vga_pVSync [get_bd_pins rgb2vga_0/vga_pVSync] [get_bd_ports vga_pVSync]
  ...
  connect_bd_net -net rst_clk_wiz_0_50M_peripheral_aresetn [get_bd_pins rst_clk_wiz_0_50M/peripheral_aresetn] [get_bd_pins AXI_GammaCorrection_A/aAxiLiteReset_n] [get_bd_pins AXI_GammaCorrection_B/aAxiLiteReset_n] [get_bd_pins AXI_GammaCorrection_C/aAxiLiteReset_n] [get_bd_pins AXI_GammaCorrection_D/aAxiLiteReset_n] [get_bd_pins MIPI_CSI_2_RX_A/s_axi_lite_aresetn] [get_bd_pins MIPI_CSI_2_RX_B/s_axi_lite_aresetn] [get_bd_pins MIPI_CSI_2_RX_C/s_axi_lite_aresetn] [get_bd_pins MIPI_CSI_2_RX_D/s_axi_lite_aresetn] [get_bd_pins MIPI_D_PHY_RX_A/s_axi_lite_aresetn] [get_bd_pins MIPI_D_PHY_RX_B/s_axi_lite_aresetn] [get_bd_pins MIPI_D_PHY_RX_C/s_axi_lite_aresetn] [get_bd_pins MIPI_D_PHY_RX_D/s_axi_lite_aresetn] [get_bd_pins axi_cama_bta/s_axi_aresetn] [get_bd_pins axi_cama_gpio/s_axi_aresetn] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S01_ARESETN] [get_bd_pins axi_mem_intercon_1/S02_ARESETN] [get_bd_pins axi_mem_intercon_1/S03_ARESETN] [get_bd_pins axi_vdma_a/axi_resetn] [get_bd_pins axi_vdma_b/axi_resetn] [get_bd_pins axi_vdma_c/axi_resetn] [get_bd_pins axi_vdma_d/axi_resetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/M08_ARESETN] [get_bd_pins ps7_0_axi_periph/M09_ARESETN] [get_bd_pins ps7_0_axi_periph/M10_ARESETN] [get_bd_pins ps7_0_axi_periph/M11_ARESETN] [get_bd_pins ps7_0_axi_periph/M12_ARESETN] [get_bd_pins ps7_0_axi_periph/M13_ARESETN] [get_bd_pins ps7_0_axi_periph/M14_ARESETN] [get_bd_pins ps7_0_axi_periph/M15_ARESETN] [get_bd_pins ps7_0_axi_periph/M19_ARESETN] [get_bd_pins ps7_0_axi_periph/M20_ARESETN] [get_bd_pins ps7_0_axi_periph/M21_ARESETN] [get_bd_pins ps7_0_axi_periph/M22_ARESETN] [get_bd_pins ps7_0_axi_periph/M23_ARESETN] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins video_dynclk/s_axi_aresetn] [get_bd_pins vtg/s_axi_aresetn]
  connect_bd_net -net rst_clk_wiz_0_50M_peripheral_reset [get_bd_pins rst_clk_wiz_0_50M/peripheral_reset] [get_bd_pins MIPI_D_PHY_RX_A/aRst] [get_bd_pins MIPI_D_PHY_RX_B/aRst] [get_bd_pins MIPI_D_PHY_RX_C/aRst] [get_bd_pins MIPI_D_PHY_RX_D/aRst]
  connect_bd_net -net rst_system_150M_peripheral_aresetn [get_bd_pins rst_system_150M/peripheral_aresetn] [get_bd_pins AXI_BayerToRGB_A/sStreamReset_n] [get_bd_pins AXI_BayerToRGB_B/sStreamReset_n] [get_bd_pins AXI_BayerToRGB_C/sStreamReset_n] [get_bd_pins AXI_BayerToRGB_D/sStreamReset_n] [get_bd_pins AXI_GammaCorrection_A/sStreamReset_n] [get_bd_pins AXI_GammaCorrection_B/sStreamReset_n] [get_bd_pins AXI_GammaCorrection_C/sStreamReset_n] [get_bd_pins AXI_GammaCorrection_D/sStreamReset_n] [get_bd_pins video_scaler_a/ap_rst_n] [get_bd_pins video_scaler_b/ap_rst_n] [get_bd_pins video_scaler_c/ap_rst_n] [get_bd_pins video_scaler_d/ap_rst_n] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M16_ARESETN] [get_bd_pins ps7_0_axi_periph/M17_ARESETN] [get_bd_pins ps7_0_axi_periph/M18_ARESETN]
  ...
  connect_bd_net -net s2mm_frame_ptr_out [get_bd_pins axi_vdma_a/s2mm_frame_ptr_out] [get_bd_pins frame_ptr_concat/In0]
  connect_bd_net -net s_axil_clk_50 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins AXI_GammaCorrection_A/AxiLiteClk] [get_bd_pins AXI_GammaCorrection_B/AxiLiteClk] [get_bd_pins AXI_GammaCorrection_C/AxiLiteClk] [get_bd_pins AXI_GammaCorrection_D/AxiLiteClk] [get_bd_pins MIPI_CSI_2_RX_A/s_axi_lite_aclk] [get_bd_pins MIPI_CSI_2_RX_B/s_axi_lite_aclk] [get_bd_pins MIPI_CSI_2_RX_C/s_axi_lite_aclk] [get_bd_pins MIPI_CSI_2_RX_D/s_axi_lite_aclk] [get_bd_pins MIPI_D_PHY_RX_A/s_axi_lite_aclk] [get_bd_pins MIPI_D_PHY_RX_B/s_axi_lite_aclk] [get_bd_pins MIPI_D_PHY_RX_C/s_axi_lite_aclk] [get_bd_pins MIPI_D_PHY_RX_D/s_axi_lite_aclk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_clk_wiz_0_50M/slowest_sync_clk] [get_bd_pins axi_cama_bta/s_axi_aclk] [get_bd_pins axi_cama_gpio/s_axi_aclk] [get_bd_pins axi_vdma_a/s_axi_lite_aclk] [get_bd_pins axi_vdma_b/s_axi_lite_aclk] [get_bd_pins axi_vdma_c/s_axi_lite_aclk] [get_bd_pins axi_vdma_d/s_axi_lite_aclk] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M07_ACLK] [get_bd_pins ps7_0_axi_periph/M08_ACLK] [get_bd_pins ps7_0_axi_periph/M09_ACLK] [get_bd_pins ps7_0_axi_periph/M10_ACLK] [get_bd_pins ps7_0_axi_periph/M11_ACLK] [get_bd_pins ps7_0_axi_periph/M12_ACLK] [get_bd_pins ps7_0_axi_periph/M13_ACLK] [get_bd_pins ps7_0_axi_periph/M14_ACLK] [get_bd_pins ps7_0_axi_periph/M15_ACLK] [get_bd_pins ps7_0_axi_periph/M19_ACLK] [get_bd_pins ps7_0_axi_periph/M20_ACLK] [get_bd_pins ps7_0_axi_periph/M21_ACLK] [get_bd_pins ps7_0_axi_periph/M22_ACLK] [get_bd_pins ps7_0_axi_periph/M23_ACLK] [get_bd_pins video_dynclk/s_axi_aclk] [get_bd_pins vtg/s_axi_aclk]
  connect_bd_net -net v_axi4s_vid_out_0_vtg_ce [get_bd_pins v_axi4s_vid_out_0/vtg_ce] [get_bd_pins vtg/gen_clken]
  connect_bd_net -net v_tc_0_irq [get_bd_pins vtg/irq] [get_bd_pins irq_concat/In0]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins irq_concat/dout] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins frame_ptr_concat/dout] [get_bd_pins axi_vdma_a/mm2s_frame_ptr_in] [get_bd_pins axi_vdma_a/s2mm_frame_ptr_in] [get_bd_pins axi_vdma_b/s2mm_frame_ptr_in] [get_bd_pins axi_vdma_c/s2mm_frame_ptr_in] [get_bd_pins axi_vdma_d/s2mm_frame_ptr_in]

  # Create address segments
  assign_bd_address -offset 0x43CE0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI_GammaCorrection_A/AXI_Lite_Reg_Intf/Reg] -force
  assign_bd_address -offset 0x43CF0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI_GammaCorrection_B/AXI_Lite_Reg_Intf/Reg] -force
  assign_bd_address -offset 0x43D00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI_GammaCorrection_C/AXI_Lite_Reg_Intf/Reg] -force
  assign_bd_address -offset 0x43D10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI_GammaCorrection_D/AXI_Lite_Reg_Intf/Reg] -force
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs MIPI_CSI_2_RX_A/S_AXI_LITE/S_AXI_LITE_reg] -force
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs MIPI_CSI_2_RX_B/S_AXI_LITE/S_AXI_LITE_reg] -force
  assign_bd_address -offset 0x43C20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs MIPI_CSI_2_RX_C/S_AXI_LITE/S_AXI_LITE_reg] -force
  assign_bd_address -offset 0x43C30000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs MIPI_CSI_2_RX_D/S_AXI_LITE/S_AXI_LITE_reg] -force
  assign_bd_address -offset 0x43C40000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs MIPI_D_PHY_RX_A/S_AXI_LITE/S_AXI_LITE_reg] -force
  assign_bd_address -offset 0x43C50000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs MIPI_D_PHY_RX_B/S_AXI_LITE/S_AXI_LITE_reg] -force
  assign_bd_address -offset 0x43C60000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs MIPI_D_PHY_RX_C/S_AXI_LITE/S_AXI_LITE_reg] -force
  assign_bd_address -offset 0x43C70000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs MIPI_D_PHY_RX_D/S_AXI_LITE/S_AXI_LITE_reg] -force
  ...
  assign_bd_address -offset 0x43010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_vdma_b/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x43020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_vdma_c/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x43030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_vdma_d/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x43C80000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs video_dynclk/s_axi_lite/Reg] -force
  assign_bd_address -offset 0x43C90000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs video_scaler_a/s_axi_ctrl/Reg] -force
  assign_bd_address -offset 0x43CA0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs video_scaler_b/s_axi_ctrl/Reg] -force
  assign_bd_address -offset 0x43CB0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs video_scaler_c/s_axi_ctrl/Reg] -force
  assign_bd_address -offset 0x43CC0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs video_scaler_d/s_axi_ctrl/Reg] -force
  assign_bd_address -offset 0x43CD0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs vtg/ctrl/Reg] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_vdma_b/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_vdma_c/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_vdma_d/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] -force
